@extends('layouts.app', ['title' => __('Edit Jabatan '.$jabatan->nama_jabatan)])

@section('content')
@include('admin.header', ['halaman' => __('Edit Jabatan '.$jabatan->nama_jabatan)])
  ...
  <div class="row justify-content-center">
    <div class="col-xl-8 order-xl-1 mb-3">
      ...
      <div class="card bg-secondary shadow mb-3">
        ...
        <div class="card-body">
          <form method="post" action="/jabatan/{{ $jabatan->id }}" autocomplete="off">
            @method('put')
            @csrf
            ...
            <div class="pl-lg-4">
              <div class="form-group{{ $errors->has('nama_jabatan') ? ' has-danger' : '' }}">
                ...
                <input type="text" name="nama_jabatan" id="nama_jabatan"
                  ...
                  placeholder="{{ __('Nama Jabatan') }}" value="{{ old('nama_jabatan',$jabatan->nama_jabatan) }}"
                  required autofocus>
              ...
              <div class="form-group{{ $errors->has('nama_unit') ? ' has-danger' : '' }}">
                ...
                <input type="text" name="nama_unit" id="nama_unit"
                  ...
                  placeholder="{{ __('Nama Unit') }}" value="{{ old('nama_unit',$jabatan->nama_unit) }}" required
                  autofocus>
              ...
              <div class="form-group{{ $errors->has('jenis_jabatan') ? ' has-danger' : '' }}">
                ...
                <select
                  ...
                  name="jenis_jabatan" id="jenis_jabatan" aria-label="Default select example" required>
                  <option @if(old("jenis_jabatan",$jabatan->jenis_jabatan)=='' ) selected @endif value=''
                    disabled>Pilih jenis Jabatan</option>
                  <option @if(old("jenis_jabatan",$jabatan->jenis_jabatan)=='Struktural' ) selected @endif
                    value='Struktural'>Struktural
                  </option>
                  <option @if(old("jenis_jabatan",$jabatan->jenis_jabatan)=='Fungsional' ) selected @endif
                    value='Fungsional'>Fungsional
                  </option>
                  <option @if(old("jenis_jabatan",$jabatan->jenis_jabatan)=='Pelaksana' ) selected @endif
              ...
              <div class="form-group{{ $errors->has('ikhtisar') ? ' has-danger' : '' }}">
                ...
                <textarea name="ikhtisar" id="ikhtisar" cols="30" rows="10"
                  ...
                  placeholder="{{ __('Masukkan Ikhtisar') }}" value="{{ old('ikhtisar',$jabatan->ikhtisar) }}"
                  required>{{ old('ikhtisar',$jabatan->ikhtisar) }}</textarea>
          ...
          <div class="pl-lg-4">
            <div class="form-group{{ $errors->has('pdd_formal') ? ' has-danger' : '' }}">
              ...
              <input type="text" name="pdd_formal" id="pdd_formal"
                ...
                placeholder="{{ __('Pendidikan Formal') }}" value="{{ old('pdd_formal',$jabatan->pdd_formal) }}"
                required autofocus>
            ...
            <div class="form-group{{ $errors->has('pdd_jurusan') ? ' has-danger' : '' }}">
              ...
              <textarea name="pdd_jurusan" id="pdd_jurusan" cols="30" rows="10"
                ...
                placeholder="{{ __('Masukkan Pendidikan Jurusan') }}"
                value="{{ old('pdd_jurusan',$jabatan->pdd_jurusan) }}"
                required>{{ old('pdd_jurusan',$jabatan->pdd_jurusan) }}</textarea>
            ...
            <div class="form-group{{ $errors->has('pelatihan_struktural') ? ' has-danger' : '' }}">
              ...
              <input type="text" name="pelatihan_struktural" id="pelatihan_struktural"
                ...
                value="{{ old('pelatihan_struktural',$jabatan->pelatihan_struktural) }}" required autofocus>
            ...
            <div class="form-group{{ $errors->has('pelatihan_fungsional') ? ' has-danger' : '' }}">
              ...
              <input type="text" name="pelatihan_fungsional" id="pelatihan_fungsional"
                ...
                placeholder="{{ __('Jika tidak ada ketik " Tidak Dipersyaratkan"') }}"
                value="{{ old('pelatihan_fungsional',$jabatan->pelatihan_fungsional) }}" required autofocus>
            ...
            <div class="form-group{{ $errors->has('pelatihan_teknis') ? ' has-danger' : '' }}">
              ...
              <input type="text" name="pelatihan_teknis" id="pelatihan_teknis"
                ...
                placeholder="{{ __('Jika tidak ada ketik " Tidak Dipersyaratkan"') }}"
                value="{{ old('pelatihan_teknis',$jabatan->pelatihan_teknis) }}" required autofocus>
            ...
            <div class="form-group{{ $errors->has('pengalaman_kerja') ? ' has-danger' : '' }}">
              ...
              <textarea name="pengalaman_kerja" id="pengalaman_kerja" cols="30" rows="10"
                ...
                placeholder="{{ __('Masukkan Pengalaman Kerja') }}"
                value="{{ old('pengalaman_kerja',$jabatan->pengalaman_kerja) }}"
                required>{{ old('pengalaman_kerja',$jabatan->pengalaman_kerja) }}</textarea>
      ...
      <div class="card bg-secondary shadow mb-3">
        ...
        <div class="card-body">
          ...
          <div class="pl-lg-2">
            <?php $i= 0?>
            @foreach($tugas_pokok as $index)
            <div class="form-group{{ $errors->has('ut<?php.str($i+1)?>') ? ' has-danger' : '' }}">
              <div class="row align-items-center">
                <div class="col-8">
                  <label class="form-control-label" for="ut<?php.str($i+1)?>">{{ __('Uraian Tugas
                    ke-'.str($i+1))}}
                  </label>
                  <textarea name="uraian_tugas[]" id="ut<?php.str($i+1)?>" cols="30" rows="3"
                    class="form-control form-control-{{ $errors->has('ut'.str($i+1)) ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Uraian Tugas'.str($i+1)) }}"
                    value="{{ old('uraian_tugas.'.str($i),$index->uraian_tugas) }}"
                    required>{{ old('uraian_tugas.'.str($i),$index->uraian_tugas) }}</textarea>
                  @if ($errors->has('ut
                  <?php.str($i+1)?>'))
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $errors->first('ut
                      <?php.str($i+1)?>') }}
                    </strong>
                  </span>
                  @endif
                ...
                <div class="col-4">
                  <label class="form-control-label" for="hk{{str($i+1) }}">{{ __('Hasil Kerja ke-'.str($i+1))}}</label>
                  <input type="text" name="hasil_kerja[]" id="hk{{ str($i+1) }}"
                    class="form-control form-control-{{ $errors->has('hk'.str($i+1)) ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Hasil Kerja '.str($i+1)) }}"
                    value="{{ old('hasil_kerja.'.str($i+1),$index->hasil_kerja) }}" required autofocus>

                  @if ($errors->has('hk'.str($i+1)))
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $errors->first('hk'.str($i+1)) }}
                    </strong>
                  </span>
                  @endif
                </div>
          ...
          <div class="pl-lg-4">
            <div class="form-group{{ $errors->has('hasil_kerja_jabatan') ? ' has-danger' : '' }}">
              ...
              <textarea name="hasil_kerja_jabatan" id="hasil_kerja_jabatan" cols="30" rows="10"
                ...
                placeholder="{{ __('Masukkan Hasil Kerja') }}"
                value="{{ old('hasil_kerja_jabatan',$jabatan->hasil_kerja_jabatan) }}"
                required>{{ old('hasil_kerja_jabatan',$jabatan->hasil_kerja_jabatan) }}</textarea>
      ...
      <div class="card bg-secondary shadow mb-3">
        ...
        <div class="card-body">
          ...
          <div class="pl-lg-2">
              ...
              <div class="row align-items-center">
                ...
                <div class="col-4">
                  <label class="form-control-label" for="penggunaan_bahan_1">{{ __('Penggunaan Dalam Tugas
                    ke-1')}}</label>
                  <input type="text" name="penggunaan_bahan[]" id="penggunaan_bahan_1"
                    class="form-control form-control-{{ $errors->has('penggunaan_bahan_1') ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan_bahan.0') }}" required
                    autofocus>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-4">
                  <label class="form-control-label" for="penggunaan_bahan_2">{{ __('Penggunaan Dalam Tugas
                    ke-2')}}</label>
                  <input type="text" name="penggunaan_bahan[]" id="penggunaan_bahan_2"
                    class="form-control form-control-{{ $errors->has('penggunaan_bahan_2') ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan_bahan.1') }}" required
                    autofocus>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-4">
                  <label class="form-control-label" for="penggunaan_bahan_3">{{ __('Penggunaan Dalam Tugas
                    ke-3')}}</label>
                  <input type="text" name="penggunaan_bahan[]" id="penggunaan_bahan_3"
                    class="form-control form-control-{{ $errors->has('penggunaan_bahan_3') ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan_bahan.2') }}" required
                    autofocus>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-4">
                  <label class="form-control-label" for="penggunaan_bahan_4">{{ __('Penggunaan Dalam Tugas
                    ke-4')}}</label>
                  <input type="text" name="penggunaan_bahan[]" id="penggunaan_bahan_4"
                    class="form-control form-control-{{ $errors->has('penggunaan_bahan_4') ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan_bahan.3') }}" required
                    autofocus>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-4">
                  <label class="form-control-label" for="penggunaan_bahan_5">{{ __('Penggunaan Dalam Tugas
                    ke-5')}}</label>
                  <input type="text" name="penggunaan_bahan[]" id="penggunaan_bahan_5"
                    class="form-control form-control-{{ $errors->has('penggunaan_bahan_5') ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan_bahan.4') }}" required
                    autofocus>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-4">
                  <label class="form-control-label" for="penggunaan_bahan_6">{{ __('Penggunaan Dalam Tugas
                    ke-6')}}</label>
                  <input type="text" name="penggunaan_bahan[]" id="penggunaan_bahan_6"
                    class="form-control form-control-{{ $errors->has('penggunaan_bahan_6') ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan_bahan.5') }}" required
                    autofocus>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-4">
                  <label class="form-control-label" for="penggunaan_bahan_7">{{ __('Penggunaan Dalam Tugas
                    ke-7')}}</label>
                  <input type="text" name="penggunaan_bahan[]" id="penggunaan_bahan_7"
                    class="form-control form-control-{{ $errors->has('penggunaan_bahan_7') ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan_bahan.6') }}" required
                    autofocus>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-4">
                  <label class="form-control-label" for="penggunaan_bahan_8">{{ __('Penggunaan Dalam Tugas
                    ke-8')}}</label>
                  <input type="text" name="penggunaan_bahan[]" id="penggunaan_bahan_8"
                    class="form-control form-control-{{ $errors->has('penggunaan_bahan_8') ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan_bahan.7') }}" required
                    autofocus>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-4">
                  <label class="form-control-label" for="penggunaan_bahan_9">{{ __('Penggunaan Dalam Tugas
                    ke-9')}}</label>
                  <input type="text" name="penggunaan_bahan[]" id="penggunaan_bahan_9"
                    class="form-control form-control-{{ $errors->has('penggunaan_bahan_9') ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan_bahan.8') }}" required
                    autofocus>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-4">
                  <label class="form-control-label" for="penggunaan_bahan_10">{{ __('Penggunaan Dalam Tugas
                    ke-10')}}</label>
                  <input type="text" name="penggunaan_bahan[]" id="penggunaan_bahan_10"
                    class="form-control form-control-{{ $errors->has('penggunaan_bahan_10') ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan_bahan.9') }}" required
                    autofocus>
            ...
            @else
            <?php $i= 0;?>
            @foreach($bahan_kerja as $index)
            <div class="form-group{{ $errors->has('bahan<?php.str($i+1)?>') ? ' has-danger' : '' }}">
              <div class="row align-items-center">
                <div class="col-8">
                  <label class="form-control-label" for="bahan<?php.str($i+1)?>">{{ __('Bahan Kerja
                    ke-'.str($i+1))}}
                  </label>
                  <textarea name="bahan_kerja[]" id="bahan<?php.str($i+1)?>" cols="30" rows="3"
                    class="form-control form-control-{{ $errors->has('bahan'.str($i+1)) ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Bahan Kerja'.str($i+1)) }}"
                    value="{{ old('bahan_kerja.'.str($i),$index->bahan_kerja) }}"
                    required>{{ old('bahan_kerja.'.str($i),$index->bahan_kerja) }}</textarea>
                  @if ($errors->has('bahan
                  <?php.str($i+1)?>'))
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $errors->first('bahan
                      <?php.str($i+1)?>') }}
                    </strong>
                  </span>
                  @endif
                ...
                <div class="col-4">
                  <label class="form-control-label" for="penggunaan_bahan{{str($i+1) }}">{{ __('Penggunaan Dalam Tugas
                    ke-'.str($i+1))}}</label>
                  <input type="text" name="penggunaan_bahan[]" id="penggunaan_bahan{{ str($i+1) }}"
                    class="form-control form-control-{{ $errors->has('penggunaan_bahan'.str($i+1)) ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Penggunaan Dalam Tugas '.str($i+1)) }}"
                    value="{{ old('penggunaan_bahan.'.str($i+1),$index->penggunaan_bahan) }}" required autofocus>

                  @if ($errors->has('penggunaan_bahan'.str($i+1)))
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $errors->first('penggunaan_bahan'.str($i+1)) }}
                    </strong>
                  </span>
                  @endif
                </div>
            ...
            <?php $i++ ?>
            @endforeach
            @while($i < 10) <div class="form-group{{ $errors->has('bahan<?php.str($i+1)?>') ? ' has-danger' : '' }}">
              <div class="row align-items-center">
                <div class="col-8">
                  <label class="form-control-label" for="bahan<?php.str($i+1)?>">{{ __('Bahan Kerja
                    ke-'.str($i+1))}}
                  ...
                  <textarea name="bahan_kerja[]" id="bahan<?php.str($i+1)?>" cols="30" rows="3"
                    class="form-control form-control-{{ $errors->has('bahan'.str($i+1)) ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Bahan Kerja'.str($i+1)) }}" value="{{ old('bahan_kerja.'.str($i)) }}"
                    required>{{ old('bahan_kerja.'.str($i)) }}</textarea>
                  @if ($errors->has('bahan
                  <?php.str($i+1)?>'))
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $errors->first('bahan
                ...
                <div class="col-4">
                  ...
                  <input type="text" name="penggunaan_bahan[]" id="penggunaan_bahan{{ str($i+1) }}"
                    class="form-control form-control-{{ $errors->has('penggunaan_bahan'.str($i+1)) ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Penggunaan Dalam Tugas '.str($i+1)) }}"
                    value="{{ old('penggunaan_bahan.'.str($i+1)) }}" required autofocus>
    ...
    <div class="card bg-secondary shadow mb-3">
      ...
      <div class="card-body">
        ...
        <div class="pl-lg-2">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-4">
                <label class="form-control-label" for="penggunaan1">{{ __('Penggunaan Dalam Tugas
                  ke-1')}}</label>
                <input type="text" name="penggunaan[]" id="penggunaan1"
                  class="form-control form-control-{{ $errors->has('penggunaan1') ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan.0') }}" required autofocus>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-4">
                <label class="form-control-label" for="penggunaan2">{{ __('Penggunaan Dalam Tugas
                  ke-2')}}</label>
                <input type="text" name="penggunaan[]" id="penggunaan2"
                  class="form-control form-control-{{ $errors->has('penggunaan2') ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan.1') }}" required autofocus>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-4">
                <label class="form-control-label" for="penggunaan3">{{ __('Penggunaan Dalam Tugas
                  ke-3')}}</label>
                <input type="text" name="penggunaan[]" id="penggunaan3"
                  class="form-control form-control-{{ $errors->has('penggunaan3') ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan.2') }}" required autofocus>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-4">
                <label class="form-control-label" for="penggunaan4">{{ __('Penggunaan Dalam Tugas
                  ke-4')}}</label>
                <input type="text" name="penggunaan[]" id="penggunaan4"
                  class="form-control form-control-{{ $errors->has('penggunaan4') ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan.3') }}" required autofocus>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-4">
                <label class="form-control-label" for="penggunaan5">{{ __('Penggunaan Dalam Tugas
                  ke-5')}}</label>
                <input type="text" name="penggunaan[]" id="penggunaan5"
                  class="form-control form-control-{{ $errors->has('penggunaan5') ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan.4') }}" required autofocus>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-4">
                <label class="form-control-label" for="penggunaan6">{{ __('Penggunaan Dalam Tugas
                  ke-6')}}</label>
                <input type="text" name="penggunaan[]" id="penggunaan6"
                  class="form-control form-control-{{ $errors->has('penggunaan6') ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan.5') }}" required autofocus>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-4">
                <label class="form-control-label" for="penggunaan7">{{ __('Penggunaan Dalam Tugas
                  ke-7')}}</label>
                <input type="text" name="penggunaan[]" id="penggunaan7"
                  class="form-control form-control-{{ $errors->has('penggunaan7') ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan.6') }}" required autofocus>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-4">
                <label class="form-control-label" for="penggunaan8">{{ __('Penggunaan Dalam Tugas
                  ke-8')}}</label>
                <input type="text" name="penggunaan[]" id="penggunaan8"
                  class="form-control form-control-{{ $errors->has('penggunaan8') ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan.7') }}" required autofocus>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-4">
                <label class="form-control-label" for="penggunaan9">{{ __('Penggunaan Dalam Tugas
                  ke-9')}}</label>
                <input type="text" name="penggunaan[]" id="penggunaan9"
                  class="form-control form-control-{{ $errors->has('penggunaan9') ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan.8') }}" required autofocus>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-4">
                <label class="form-control-label" for="penggunaan10">{{ __('Penggunaan Dalam Tugas
                  ke-10')}}</label>
                <input type="text" name="penggunaan[]" id="penggunaan10"
                  class="form-control form-control-{{ $errors->has('penggunaan10') ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Penggunaan Dalam Tugas') }}" value="{{ old('penggunaan.9') }}" required autofocus>
          ...
          @else
          <?php $i= 0;?>
          @foreach($perangkat_kerja as $index)
          <div class="form-group{{ $errors->has('perangkat_kerja<?php.str($i+1)?>') ? ' has-danger' : '' }}">
            <div class="row align-items-center">
              <div class="col-8">
                <label class="form-control-label" for="perangkat_kerja<?php.str($i+1)?>">{{ __('Perangkat Kerja
                  ke-'.str($i+1))}}
                </label>
                <textarea name="perangkat_kerja[]" id="perangkat_kerja<?php.str($i+1)?>" cols="30" rows="3"
                  class="form-control form-control-{{ $errors->has('perangkat_kerja'.str($i+1)) ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Perangkat Kerja'.str($i+1)) }}"
                  value="{{ old('perangkat_kerja.'.str($i),$index->perangkat_kerja) }}"
                  required>{{ old('perangkat_kerja.'.str($i),$index->perangkat_kerja) }}</textarea>
                @if ($errors->has('perangkat_kerja
                <?php.str($i+1)?>'))
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $errors->first('perangkat_kerja
                    <?php.str($i+1)?>') }}
                  </strong>
                </span>
                @endif
              ...
              <div class="col-4">
                <label class="form-control-label" for="penggunaan{{str($i+1) }}">{{ __('Penggunaan Dalam Tugas
                  ke-'.str($i+1))}}</label>
                <input type="text" name="penggunaan[]" id="penggunaan{{ str($i+1) }}"
                  class="form-control form-control-{{ $errors->has('penggunaan'.str($i+1)) ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Penggunaan Dalam Tugas '.str($i+1)) }}"
                  value="{{ old('hasil_kerja.'.str($i+1),$index->penggunaan) }}" required autofocus>

                @if ($errors->has('penggunaan'.str($i+1)))
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $errors->first('penggunaan'.str($i+1)) }}
                  </strong>
                </span>
                @endif
              </div>
          ...
          @endforeach
          @while($i < 10) <div
            class="form-group{{ $errors->has('perangkat_kerja<?php.str($i+1)?>') ? ' has-danger' : '' }}">
            <div class="row align-items-center">
              <div class="col-8">
                <label class="form-control-label" for="perangkat_kerja<?php.str($i+1)?>">{{ __('Perangkat Kerja
                  ke-'.str($i+1))}}
                ...
                <textarea name="perangkat_kerja[]" id="perangkat_kerja<?php.str($i+1)?>" cols="30" rows="3"
                  class="form-control form-control-{{ $errors->has('perangkat_kerja'.str($i+1)) ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Perangkat Kerja'.str($i+1)) }}" value="{{ old('perangkat_kerja.'.str($i)) }}"
                  required>{{ old('perangkat_kerja.'.str($i)) }}</textarea>
                @if ($errors->has('perangkat_kerja
                <?php.str($i+1)?>'))
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $errors->first('perangkat_kerja
              ...
              <div class="col-4">
                ...
                <input type="text" name="penggunaan[]" id="penggunaan{{ str($i+1) }}"
                  class="form-control form-control-{{ $errors->has('penggunaan'.str($i+1)) ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Penggunaan Dalam Tugas '.str($i+1)) }}"
                  value="{{ old('hasil_kerja.'.str($i+1)) }}" required autofocus>
      ...
      <div class="pl-lg-4">
        ...
        <div class="form-group{{ $errors->has('tanggung_jawab') ? ' has-danger' : '' }}">
          ...
          <textarea name="tanggung_jawab" id="tanggung_jawab" cols="30" rows="10"
            ...
            placeholder="{{ __('Tanggung Jawab') }}" value="{{ old('tanggung_jawab',$jabatan->tanggung_jawab) }}"
            required>{{ old('tanggung_jawab',$jabatan->tanggung_jawab) }}</textarea>
        ...
        <div class="form-group{{ $errors->has('wewenang') ? ' has-danger' : '' }}">
          ...
          <textarea name="wewenang" id="wewenang" cols="30" rows="10"
            ...
            placeholder="{{ __('Wewenang') }}" value="{{ old('wewenang',$jabatan->wewenang) }}"
            required>{{ old('wewenang',$jabatan->wewenang) }}</textarea>
      ...
      <div class="pl-lg-4">
        <div class="form-group{{ $errors->has('tempat_kerja') ? ' has-danger' : '' }}">
          ...
          <div class="input-group mb-4">
            <input type="number" name="tempat_kerja" id="tempat_kerja"
              ...
              placeholder="{{ __('Input 0 - 100') }}" value="{{ old('tempat_kerja',$lingkungan_kerja->tempat_kerja) }}"
              required min="0" max="100" maxlength="10" autofocus>
        ...
        <div class="form-group{{ $errors->has('suhu') ? ' has-danger' : '' }}">
          ...
          <select class="form-select form-control- form-control{{ $errors->has('suhu') ? ' is-invalid' : '' }}"
            ...
            <option @if(old("suhu",$lingkungan_kerja->suhu)=='' ) selected @endif value='' disabled>Pilih Suhu
            </option>
            <option @if(old("suhu",$lingkungan_kerja->suhu)=='Dingin' ) selected @endif value='Dingin'>Dingin
            </option>
            <option @if(old("suhu",$lingkungan_kerja->suhu)=='Sedang/Cukup' ) selected @endif
              value='Sedang/Cukup'>Sedang/Cukup
            </option>
            <option @if(old("suhu",$lingkungan_kerja->suhu)=='Panas' ) selected @endif value='Panas'>Panas
            </option>
            <option @if(old("suhu",$lingkungan_kerja->suhu)=='Semua Kondisi' ) selected @endif value='Semua
        ...
        <div class="form-group{{ $errors->has('udara') ? ' has-danger' : '' }}">
          ...
          <select class="form-select form-control- form-control{{ $errors->has('udara') ? ' is-invalid' : '' }}"
            ...
            <option @if(old("udara",$lingkungan_kerja->udara)=='' ) selected @endif value='' disabled>Pilih Udara
            </option>
            <option @if(old("udara",$lingkungan_kerja->udara)=='Sejuk' ) selected @endif value='Sejuk'>Sejuk
            </option>
            <option @if(old("udara",$lingkungan_kerja->udara)=='Sedang' ) selected @endif value='Sedang'>Sedang
            </option>
            <option @if(old("udara",$lingkungan_kerja->udara)=='Kering' ) selected @endif value='Kering'>Kering
            </option>
            <option @if(old("udara",$lingkungan_kerja->udara)=='Semua Kondisi' ) selected @endif value='Semua
              Kondisi'>Semua Kondisi
            </option>
          </select>
          @if ($errors->has('udara'))
        ...
        <div class="form-group{{ $errors->has('keadaan_ruangan') ? ' has-danger' : '' }}">
          ...
          <select
            ...
            <option @if(old("keadaan_ruangan",$lingkungan_kerja->keadaan_ruangan)=='' ) selected @endif value=''
              disabled>Pilih Keadaan Ruangan
            </option>
            <option @if(old("keadaan_ruangan",$lingkungan_kerja->keadaan_ruangan)=='Sempit' ) selected @endif
              value='Sejuk'>Sempit
            </option>
            <option @if(old("keadaan_ruangan",$lingkungan_kerja->keadaan_ruangan)=='Sedang' ) selected @endif
              value='Sedang'>Sedang
            </option>
            <option @if(old("keadaan_ruangan",$lingkungan_kerja->keadaan_ruangan)=='Luas' ) selected @endif
              value='Kering'>Luas
            </option>
            <option @if(old("keadaan_ruangan",$lingkungan_kerja->keadaan_ruangan)=='Semua Kondisi' ) selected @endif
              value='Semua Kondisi'>Semua
              Kondisi
            </option>
          </select>
        ...
        <div class="form-group{{ $errors->has('letak') ? ' has-danger' : '' }}">
          ...
          <select class="form-select form-control- form-control{{ $errors->has('letak') ? ' is-invalid' : '' }}"
            ...
            <option @if(old("letak",$lingkungan_kerja->letak)=='' ) selected @endif value='' disabled>Pilih Letak
            </option>
            <option @if(old("letak",$lingkungan_kerja->letak)=='Perdesaan' ) selected @endif
              value='Perdesaan'>Perdesaan
            </option>
            <option @if(old("letak",$lingkungan_kerja->letak)=='Perkotaan' ) selected @endif
              value='Sedang'>Perkotaan
            </option>
            <option @if(old("letak",$lingkungan_kerja->letak)=='Semua Kondisi' ) selected @endif value='Semua
              Kondisi'>Semua
              Kondisi
            </option>
          </select>
        ...
        <div class="form-group{{ $errors->has('penerangan') ? ' has-danger' : '' }}">
          ...
          <select class="form-select form-control- form-control{{ $errors->has('penerangan') ? ' is-invalid' : '' }}"
            name="penerangan" id="penerangan" aria-label="Default select example" required>
            <option @if(old("penerangan",$lingkungan_kerja->penerangan)=='' ) selected @endif value=''
              disabled>Pilih Penerangan
            </option>
            <option @if(old("penerangan",$lingkungan_kerja->penerangan)=='Terang' ) selected @endif
              value='Terang'>Terang
            </option>
            <option @if(old("penerangan",$lingkungan_kerja->penerangan)=='Redup' ) selected @endif
              value='Redup'>Redup
            </option>
            <option @if(old("penerangan",$lingkungan_kerja->penerangan)=='Gelap' ) selected @endif
              value='Gelap'>Gelap
            </option>
            <option @if(old("penerangan",$lingkungan_kerja->penerangan)=='Semua Kondisi' ) selected @endif
              value='Semua Kondisi'>Semua
              Kondisi
            </option>
          </select>
        ...
        <div class="form-group{{ $errors->has('suara') ? ' has-danger' : '' }}">
          ...
          <select class="form-select form-control- form-control{{ $errors->has('suara') ? ' is-invalid' : '' }}"
            ...
            <option @if(old("suara",$lingkungan_kerja->suara)=='' ) selected @endif value='' disabled>Pilih Suara
            </option>
            <option @if(old("suara",$lingkungan_kerja->suara)=='Tenang' ) selected @endif value='Tenang'>Tenang
            </option>
            <option @if(old("suara",$lingkungan_kerja->suara)=='Bising' ) selected @endif value='Bising'>Bising
            </option>
            <option @if(old("suara",$lingkungan_kerja->suara)=='Semua Kondisi' ) selected @endif value='Semua
              Kondisi'>Semua
              Kondisi
            </option>
          </select>
        ...
        <div class="form-group{{ $errors->has('keadaan_tempat_kerja') ? ' has-danger' : '' }}">
          ...
          <select
            ...
            <option @if(old("keadaan_tempat_kerja",$lingkungan_kerja->keadaan_tempat_kerja)=='' ) selected @endif
              value='' disabled>Pilih Keadaan Tempat
              Kerja
            </option>
            <option @if(old("keadaan_tempat_kerja",$lingkungan_kerja->keadaan_tempat_kerja)=='Bersih dan Rapi' )
              selected @endif value='Bersih dan Rapi'>
              Bersih dan Rapi
            </option>
            <option @if(old("keadaan_tempat_kerja",$lingkungan_kerja->keadaan_tempat_kerja)=='Tidak Teratur' )
              selected @endif value='Tidak Teratur'>
              Tidak
              Teratur
            </option>
            <option @if(old("keadaan_tempat_kerja",$lingkungan_kerja->keadaan_tempat_kerja)=='Semua Kondisi' )
              selected @endif value='Semua Kondisi'>
              Semua
              Kondisi
            </option>
          </select>
        ...
        <div class="form-group{{ $errors->has('getaran') ? ' has-danger' : '' }}">
          ...
          <select class="form-select form-control- form-control{{ $errors->has('getaran') ? ' is-invalid' : '' }}"
            ...
            <option @if(old("getaran",$lingkungan_kerja->getaran)=='' ) selected @endif value='' disabled>Pilih
              Getaran
            </option>
            <option @if(old("getaran",$lingkungan_kerja->getaran)=='Ada' ) selected @endif value='Ada'>Ada
            </option>
            <option @if(old("getaran",$lingkungan_kerja->getaran)=='Tidak ada' ) selected @endif value='Tidak
              ada'>Tidak ada
            </option>
            <option @if(old("getaran",$lingkungan_kerja->getaran)=='Semua Kondisi' ) selected @endif value='Semua
              Kondisi'>Semua
              Kondisi
            </option>
          </select>
      ...
      <div class="pl-lg-4">
        <div class="form-group{{ $errors->has('fisik') ? ' has-danger' : '' }}">
          ...
          <input type="text" name="fisik" id="fisik"
            ...
            placeholder="{{ __('Fisik') }}" value="{{ old('fisik',$lingkungan_kerja->fisik) }}" required autofocus>
        ...
        <div class="form-group{{ $errors->has('mental') ? ' has-danger' : '' }}">
          ...
          <input type="text" name="mental" id="mental"
            ...
            placeholder="{{ __('Mental') }}" value="{{ old('mental',$lingkungan_kerja->mental) }}" required autofocus>
    ...
    <div class="card-body">
      ...
      <div class="pl-lg-4">
        <div class="form-group{{ $errors->has('fisik') ? ' has-danger' : '' }}">
          ...
          <input type="text" name="fisik" id="fisik"
            class="form-control form-control-{{ $errors->has('fisik') ? ' is-invalid' : '' }}"
            placeholder="{{ __('Fisik') }}" value="{{ old('fisik') }}" required autofocus>
        ...
        <div class="form-group{{ $errors->has('mental') ? ' has-danger' : '' }}">
          ...
          <input type="text" name="mental" id="mental"
            class="form-control form-control-{{ $errors->has('mental') ? ' is-invalid' : '' }}"
            placeholder="{{ __('Mental') }}" value="{{ old('mental') }}" required autofocus>
      ...
      <div class="pl-lg-4">
        <div class="form-group{{ $errors->has('keterampilan') ? ' has-danger' : '' }}">
          ...
          <textarea name="keterampilan" id="keterampilan" cols="30" rows="10"
            ...
            placeholder="{{ __('Masukkan Keterampilan') }}"
            value="{{ old('keterampilan',$syarat_kerja->keterampilan) }}"
            required>{{ old('keterampilan',$syarat_kerja->keterampilan) }}</textarea>
        ...
        <div class="form-group{{ $errors->has('bakat') ? ' has-danger' : '' }}">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="bakat[]" @if(is_array(old('bakat',$bakat)) && in_array('G',
              old('bakat',$bakat))) checked @endif id="bakat1" type="checkbox" value="G">
            <label class="custom-control-label" for="bakat1">- G : Intelegensia / Kemampuan belajar secara
              umum</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="bakat[]" @if(is_array(old('bakat',$bakat)) && in_array('V',
              old('bakat',$bakat))) checked @endif id="bakat2" type="checkbox" value="V">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="bakat[]" @if(is_array(old('bakat',$bakat)) && in_array('N',
              old('bakat',$bakat))) checked @endif id="bakat3" type="checkbox" value="N">
            <label class="custom-control-label" for="bakat3">- N : Bakat Numerik / Kemampuan untuk melakukan
              operasi
              arithmatik secara tepat dan akurat</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="bakat[]" @if(is_array(old('bakat',$bakat)) && in_array('S',
              old('bakat',$bakat))) checked @endif id="bakat4" type="checkbox" value="S">
            <label class="custom-control-label" for="bakat4">- S : Bakat Pandang Ruang / Kemampuan berpikir
              secara
              visual mengenai bentuk-bentuk geometris, untuk memahami gambar-gambar dari benda-benda tiga
              dimensi</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="bakat[]" @if(is_array(old('bakat',$bakat)) && in_array('P',
              old('bakat',$bakat))) checked @endif id="bakat5" type="checkbox" value="P">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="bakat[]" @if(is_array(old('bakat',$bakat)) && in_array('Q',
              old('bakat',$bakat))) checked @endif id="bakat6" type="checkbox" value="Q">
            <label class="custom-control-label" for="bakat6">- Q : Bakat Ketelitian / Kemampuan menyerap
              perincian
              yang berkaitan dalam bahan verbal atau dalam tabel</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="bakat[]" @if(is_array(old('bakat',$bakat)) && in_array('K',
              old('bakat',$bakat))) checked @endif id="bakat7" type="checkbox" value="K">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="bakat[]" @if(is_array(old('bakat',$bakat)) && in_array('F',
              old('bakat',$bakat))) checked @endif id="bakat8" type="checkbox" value="F">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="bakat[]" @if(is_array(old('bakat',$bakat)) && in_array('E',
              old('bakat',$bakat))) checked @endif id="bakat9" type="checkbox" value="E">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="bakat[]" @if(is_array(old('bakat',$bakat)) && in_array('C',
              old('bakat',$bakat))) checked @endif id="bakat10" type="checkbox" value="C">
            <label class="custom-control-label" for="bakat10">- C : Kemampuan Membedakan Warna / Kemampuan
              memadukan
              atau membedakan berbagai warna yang asli, yang gemerlapan</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="bakat[]" @if(is_array(old('bakat',$bakat)) && in_array('M',
              old('bakat',$bakat))) checked @endif id="bakat11" type="checkbox" value="M">
            <label class="custom-control-label" for="bakat11">- M : Kecekatan Tangan / Kemampuan menggerakkan
              tangan
              dengan mudah dan penuh keterampilan</label>
          </div>
          @if ($errors->has('bakat'))
          <span class="invalid-feedback" role="alert">@if(is_array(old('bakat',$bakat)) && in_array('G',
            old('bakat',$bakat)))
            checked @endif
        ...
        <div class="form-group{{ $errors->has('temperamen') ? ' has-danger' : '' }}">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="temperamen[]" @if(is_array(old('temperamen',$temperamen)) &&
              in_array('D', old('temperamen',$temperamen))) checked @endif id="temperamen1" type="checkbox" value="D">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="temperamen[]" @if(is_array(old('temperamen',$temperamen)) &&
              in_array('F', old('temperamen',$temperamen))) checked @endif id="temperamen2" type="checkbox" value="F">
            <label class="custom-control-label" for="temperamen2">- F : Kemampuan menyesuaikan diri dengan
              kegiatan
              yang mengandung penafsiran perasaan, gagasan atau fakta dari sudut pandangan pribadi</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="temperamen[]" @if(is_array(old('temperamen',$temperamen)) &&
              in_array('I', old('temperamen',$temperamen))) checked @endif id="temperamen3" type="checkbox" value="I">
            <label class="custom-control-label" for="temperamen3">- I : Kemampuan menyesuaikan diri untuk
              pekerjaan
              - pekerjaan mempengaruhi orang lain dalam pendapat, sikap atau pertimbangan mengenai
              gagasan</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="temperamen[]" @if(is_array(old('temperamen',$temperamen)) &&
              in_array('J', old('temperamen',$temperamen))) checked @endif id="temperamen4" type="checkbox" value="J">
            <label class="custom-control-label" for="temperamen4">- J : Kemampuan menyesuaikan diri pada
              kegiatan
              perbuatan kesimpulan penilaian atau pembuatan peraturan berdasarkan kriteria rangsangan indera
              atau
              atas dasar pertimbangan pribadi</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="temperamen[]" @if(is_array(old('temperamen',$temperamen)) &&
              in_array('M', old('temperamen',$temperamen))) checked @endif id="temperamen5" type="checkbox" value="M">
            <label class="custom-control-label" for="temperamen5">- M : Kemampuan menyesuaikan diri dengan
              kegiatan
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="temperamen[]" @if(is_array(old('temperamen',$temperamen)) &&
              in_array('P', old('temperamen',$temperamen))) checked @endif id="temperamen6" type="checkbox" value="P">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="temperamen[]" @if(is_array(old('temperamen',$temperamen)) &&
              in_array('R', old('temperamen',$temperamen))) checked @endif id="temperamen7" type="checkbox" value="R">
            <label class="custom-control-label" for="temperamen7">- R : Kemampuan menyesuaikan diri dalam
              kegiatan-kegiatan yang berulang, atau secara terus menerus melakukan kegiatan yang sama, sesuai
              dengan
              perangkat prosedur, urutan atau kecepatan yang tertentu</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="temperamen[]" @if(is_array(old('temperamen',$temperamen)) &&
              in_array('S', old('temperamen',$temperamen))) checked @endif id="temperamen8" type="checkbox" value="S">
            <label class="custom-control-label" for="temperamen8">- S : Kemampuan menyesuaikan diri untuk
              bekerja
              dengan ketegangan jiwa jika berhadapan dengan keadaan darurat, kritis, tidak biasa atau bahaya,
              atau
              bekerja dengan kecepatan kerja dan perhatian terus menerus merupakan keseluruhan atau sebagian
              aspek
              pekerjaan</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="temperamen[]" @if(is_array(old('temperamen',$temperamen)) &&
              in_array('T', old('temperamen',$temperamen))) checked @endif id="temperamen9" type="checkbox" value="T">
            <label class="custom-control-label" for="temperamen9">- T : Kemampuan menyesuaikan diri dengan
              situasi
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="temperamen[]" @if(is_array(old('temperamen',$temperamen)) &&
              in_array('V', old('temperamen',$temperamen))) checked @endif id="temperamen10" type="checkbox" value='V'>
            <label class="custom-control-label" for="temperamen10">- V : Kemampuan menyesuaikan diri untuk
              melaksanakan berbagai tugas, sering berganti dari tugas yang satu ke tugas yang lainnya yang
              "berbeda"
        ...
        <div class="form-group{{ $errors->has('minat') ? ' has-danger' : '' }}">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="minat[]" @if(is_array(old('minat',$minat)) &&
              in_array('Investigatif', old('minat',$minat))) checked @endif id="minat1" type="checkbox"
              value="Investigatif">
            <label class="custom-control-label" for="minat1">- <strong>Investigatif</strong> = Kemampuan
              analisis
              ilmiah /
              ilmiah</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="minat[]" @if(is_array(old('minat',$minat)) && in_array('Artistik',
              old('minat',$minat))) checked @endif id="minat2" type="checkbox" value="Artistik">
            <label class="custom-control-label" for="minat2">- <strong>Artistik</strong> = Melakukan pemikiran
              kreatif</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="minat[]" @if(is_array(old('minat',$minat)) && in_array('Sosial',
              old('minat',$minat))) checked @endif id="minat3" type="checkbox" value="Sosial">
            <label class="custom-control-label" for="minat3">- <strong>Sosial</strong> = Menjalin hubungan
              dengan
              orang lain,
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="minat[]" @if(is_array(old('minat',$minat)) &&
              in_array('Enterpreneurial', old('minat',$minat))) checked @endif id="minat4" type="checkbox"
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="minat[]" @if(is_array(old('minat',$minat)) &&
              in_array('Konvensional', old('minat',$minat))) checked @endif id="minat5" type="checkbox"
              value="Konvensional">
        ...
        <div class="form-group{{ $errors->has('upaya_fisik') ? ' has-danger' : '' }}">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('Berdiri', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik1" type="checkbox"
              value="Berdiri">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('berjalan', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik2" type="checkbox"
              value="berjalan">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('duduk', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik3" type="checkbox"
              value="duduk">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('mengangkat', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik4" type="checkbox"
              value="mengangkat">
            <label class="custom-control-label" for="upaya_fisik4">- <strong>Mengangkat</strong> : Menaikkan
              atau
              menurunkan benda di
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('membawa', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik5" type="checkbox"
              value="membawa">
            <label class="custom-control-label" for="upaya_fisik5">- <strong>Membawa</strong> : Memindahkan
              benda,
              umumnya dengan
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('mendorong', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik6" type="checkbox"
              value="mendorong">
            <label class="custom-control-label" for="upaya_fisik6">- <strong>Mendorong</strong> : Menggunakan
              tenaga
              untuk
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('menarik', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik7" type="checkbox"
              value="menarik">
            <label class="custom-control-label" for="upaya_fisik7">- <strong>Menarik</strong> : Menggunakan
              tenaga
              untuk memindahkan
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('memanjat', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik8" type="checkbox"
              value="memanjat">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('menyimpan imbangan / mengatur imbangan', old('upaya_fisik',$upaya_fisik))) checked @endif
            ...
            <label class="custom-control-label" for="upaya_fisik9">- <strong>Menyimpan imbangan / mengatur
              ...
              tidak jatuh badan waktu berjalan, berdiri, membungkuk, atau beiiari di atas tempat yang agak
              sempit,
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('menunduk', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik10" type="checkbox"
              value='menunduk'>
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('berlutut', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik11" type="checkbox"
              value='berlutut'>
            <label class="custom-control-label" for="upaya_fisik11">- <strong>Berlutut</strong> : Melengkungkan
              paha
              kaki pada lutut dan berdiam di suatu tempat dengan tubuh diatas lutut</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('membungkuk', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik12" type="checkbox"
              value='membungkuk'>
            <label class="custom-control-label" for="upaya_fisik12">- <strong>Membungkuk</strong> :
              Melengkungkan
              tubuh dengan cara melengkungkan tulang punggung sampai kira-kira sejajar dengan pinggang</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('merangkak', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik13" type="checkbox"
              value='merangkak'>
            <label class="custom-control-label" for="upaya_fisik13">- <strong>Merangkak</strong> : Bergerak
              dengan
              menggunakan tangan dan lutut atau kaki dan tangan</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('menjangkau', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik14" type="checkbox"
              value='menjangkau'>
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('memegang', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik15" type="checkbox"
              value='memegang'>
            <label class="custom-control-label" for="upaya_fisik15">- <strong>Memegang</strong> : Dengan satu
              atau
              dua tangan mengukur, menggenggam, memutar dan lain sebagainya</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('bekerja dengan jari', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik16"
              type="checkbox" value='bekerja dengan jari'>
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('meraba', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik17" type="checkbox"
              value='meraba'>
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('berbicara', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik18" type="checkbox"
              value='berbicara'>
            <label class="custom-control-label" for="upaya_fisik18">- <strong>Berbicara</strong> : Menyatakan
              atau
              bertukar pikiran secara lisan agar dapat dipahami</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('mendengar', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik19" type="checkbox"
              value='mendengar'>
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('melihat', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik20" type="checkbox"
              value='melihat'>
            <label class="custom-control-label" for="upaya_fisik20">- <strong>Melihat</strong> : Usaha
              mengetahui
              dengan menggunakan mata</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('ketajaman jarak jauh', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik21"
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('ketajaman jarak dekat', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik22"
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('pengamatan secara mendalam', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik23"
              type="checkbox" value='pengamatan secara mendalam'>
            <label class="custom-control-label" for="upaya_fisik23">- <strong>Pengamatan Secara
                Mendalam</strong>
              :
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('penyesuaian lensa mata', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik24"
            ...
            <label class="custom-control-label" for="upaya_fisik24">- <strong>Penyesuaian Lensa Mata</strong> :
              Penyesuaian lensa mata untuk melihat suatu benda yang sangat penting bila melaksanakan pekerjaan
              yang
              perlu dengan melihat benda-benda dalam jarak dan arah yang berbeda</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('melihat berbagai warna', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik25"
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik',$upaya_fisik)) &&
              in_array('luas', old('upaya_fisik',$upaya_fisik))) checked @endif id="upaya_fisik26" type="checkbox"
              value='luas'>
            <label class="custom-control-label" for="upaya_fisik26">- <strong>Luas</strong> : Melihat suatu
              daerah
        ...
        <div class="form-group{{ $errors->has('jenis_kelamin') ? ' has-danger' : '' }}">
          ...
          <select class="form-select form-control- form-control{{ $errors->has('jenis_kelamin') ? ' is-invalid' : '' }}"
            name="jenis_kelamin" id="jenis_kelamin" aria-label="Default select example" required>
            <option @if(old("jenis_kelamin",$syarat_kerja->jenis_kelamin)=='Tidak Dipersyaratkan' ) selected @endif
              value='Tidak Dipersyaratkan'>
              Tidak Dipersyaratkan
            </option>
            <option @if(old("jenis_kelamin",$syarat_kerja->jenis_kelamin)=='Laki - Laki' ) selected @endif
              value='Laki - Laki'>Laki - Laki
            </option>
            <option @if(old("jenis_kelamin",$syarat_kerja->jenis_kelamin)=='Perempuan' ) selected @endif
        ...
        <div class="form-group{{ $errors->has('umur') ? ' has-danger' : '' }}">
          ...
          <div class="input-group mb-4">
            <input type="text" name="umur" id="umur"
              ...
              placeholder="{{ __('Input Umur') }}" value="{{ old('umur',$syarat_kerja->umur) }}" required>
          </div>
          @if ($errors->has('umur'))
          <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group{{ $errors->has('tinggi') ? ' has-danger' : '' }}">
          ...
          <div class="input-group mb-4">
            <input type="text" name="tinggi" id="tinggi"
              ...
              placeholder="{{ __('Input Tinggi Badan') }}" value="{{ old('tinggi',$syarat_kerja->tinggi) }}" required>
          </div>
        ...
        <div class="form-group{{ $errors->has('berat') ? ' has-danger' : '' }}">
          ...
          <div class="input-group mb-4">
            <input type="text" name="berat" id="berat"
              ...
              placeholder="{{ __('Input Berat Badan') }}" value="{{ old('berat',$syarat_kerja->berat) }}" required>
          </div>
          @if ($errors->has('berat'))
          <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group{{ $errors->has('postur') ? ' has-danger' : '' }}">
          ...
          <div class="input-group mb-4">
            <input type="text" name="postur" id="postur"
              ...
              placeholder="{{ __('Input Postur Badan') }}" value="{{ old('postur',$syarat_kerja->postur) }}" required>
          </div>
        ...
        <div class="form-group{{ $errors->has('penampilan') ? ' has-danger' : '' }}">
          ...
          <div class="input-group mb-4">
            <input type="text" name="penampilan" id="penampilan"
              ...
              placeholder="{{ __('Input Penampilan') }}" value="{{ old('penampilan',$syarat_kerja->penampilan) }}"
              required>
          </div>
        ...
        <div class="form-group{{ $errors->has('hubungan_data') ? ' has-danger' : '' }}">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_data[]" @if(is_array(old('hubungan_data',$hubungan_data))
              && in_array('D0', old('hubungan_data',$hubungan_data))) checked @endif id="hubungan_data1" type="checkbox"
              value="D0">
            <label class="custom-control-label" for="hubungan_data1">- <strong>D0</strong> = Memadukan
              data</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_data[]" @if(is_array(old('hubungan_data',$hubungan_data))
              && in_array('D1', old('hubungan_data',$hubungan_data))) checked @endif id="hubungan_data2" type="checkbox"
              value="D1">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_data[]" @if(is_array(old('hubungan_data',$hubungan_data))
              && in_array('D2', old('hubungan_data',$hubungan_data))) checked @endif id="hubungan_data3" type="checkbox"
              value="D2">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_data[]" @if(is_array(old('hubungan_data',$hubungan_data))
              && in_array('D3', old('hubungan_data',$hubungan_data))) checked @endif id="hubungan_data4" type="checkbox"
              value="D3">
            <label class="custom-control-label" for="hubungan_data4">- <strong>D3</strong> = Menyusun
              data</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_data[]" @if(is_array(old('hubungan_data',$hubungan_data))
              && in_array('D4', old('hubungan_data',$hubungan_data))) checked @endif id="hubungan_data5" type="checkbox"
              value="D4">
            <label class="custom-control-label" for="hubungan_data5">- <strong>D4</strong> = Menghitung
              data</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_data[]" @if(is_array(old('hubungan_data',$hubungan_data))
              && in_array('D5', old('hubungan_data',$hubungan_data))) checked @endif id="hubungan_data6" type="checkbox"
              value="D5">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_data[]" @if(is_array(old('hubungan_data',$hubungan_data))
              && in_array('D6', old('hubungan_data',$hubungan_data))) checked @endif id="hubungan_data7" type="checkbox"
              value="D6">
            <label class="custom-control-label" for="hubungan_data7">- <strong>D6</strong> = Menyalin
              data</label>
          </div>
        ...
        <div class="form-group{{ $errors->has('hubungan_orang') ? ' has-danger' : '' }}">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_orang[]"
              @if(is_array(old('hubungan_orang',$hubungan_orang)) && in_array('O0',
              old('hubungan_orang',$hubungan_orang))) checked @endif id="hubungan_orang1" type="checkbox" value="O0">
            <label class="custom-control-label" for="hubungan_orang1">- <strong>O0</strong> = Menasehati</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_orang[]"
              @if(is_array(old('hubungan_orang',$hubungan_orang)) && in_array('O1',
              old('hubungan_orang',$hubungan_orang))) checked @endif id="hubungan_orang2" type="checkbox" value="O1">
            <label class="custom-control-label" for="hubungan_orang2">- <strong>O1</strong> = Berunding</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_orang[]"
              @if(is_array(old('hubungan_orang',$hubungan_orang)) && in_array('O2',
              old('hubungan_orang',$hubungan_orang))) checked @endif id="hubungan_orang3" type="checkbox" value="O2">
            <label class="custom-control-label" for="hubungan_orang3">- <strong>O2</strong> = Mengajar</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_orang[]"
              @if(is_array(old('hubungan_orang',$hubungan_orang)) && in_array('O3',
              old('hubungan_orang',$hubungan_orang))) checked @endif id="hubungan_orang4" type="checkbox" value="O3">
            <label class="custom-control-label" for="hubungan_orang4">- <strong>O3</strong> = Menyelia</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_orang[]"
              @if(is_array(old('hubungan_orang',$hubungan_orang)) && in_array('O4',
              old('hubungan_orang',$hubungan_orang))) checked @endif id="hubungan_orang5" type="checkbox" value="O4">
            <label class="custom-control-label" for="hubungan_orang5">- <strong>O4</strong> = Menghibur</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_orang[]"
              @if(is_array(old('hubungan_orang',$hubungan_orang)) && in_array('O5',
              old('hubungan_orang',$hubungan_orang))) checked @endif id="hubungan_orang6" type="checkbox" value="O5">
            <label class="custom-control-label" for="hubungan_orang6">- <strong>O5</strong> =
              Mempengaruhi</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_orang[]"
              @if(is_array(old('hubungan_orang',$hubungan_orang)) && in_array('O6',
              old('hubungan_orang',$hubungan_orang))) checked @endif id="hubungan_orang7" type="checkbox" value="O6">
            <label class="custom-control-label" for="hubungan_orang7">- <strong>O6</strong> = Berbicara -
              memberi
              tanda</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_orang[]"
              @if(is_array(old('hubungan_orang',$hubungan_orang)) && in_array('O7',
              old('hubungan_orang',$hubungan_orang))) checked @endif id="hubungan_orang8" type="checkbox" value="O7">
            <label class="custom-control-label" for="hubungan_orang8">- <strong>O7</strong> = Melayani
              orang</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_orang[]"
              @if(is_array(old('hubungan_orang',$hubungan_orang)) && in_array('O8',
              old('hubungan_orang',$hubungan_orang))) checked @endif id="hubungan_orang9" type="checkbox" value="O8">
        ...
        <div class="form-group{{ $errors->has('hubungan_benda') ? ' has-danger' : '' }}">
          <label class="form-control-label" for="hubungan_benda" required>{{ __('Hubungan Dengan Benda') }}</label>
          <div class="custom-control custom-checkbox mb-3 ">
            <input class="custom-control-input" name="hubungan_benda[]"
              @if(is_array(old('hubungan_benda',$hubungan_benda)) && in_array('B0',
              old('hubungan_benda',$hubungan_benda))) checked @endif id="hubungan_benda1" type="checkbox" value="B0">
            <label class="custom-control-label" for="hubungan_benda1">- <strong>B0</strong> = Memasang
              mesin</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_benda[]"
              @if(is_array(old('hubungan_benda',$hubungan_benda)) && in_array('B1',
              old('hubungan_benda',$hubungan_benda))) checked @endif id="hubungan_benda2" type="checkbox" value="B1">
            <label class="custom-control-label" for="hubungan_benda2">- <strong>B1</strong> = Mengerjakan
              persisi</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_benda[]"
              @if(is_array(old('hubungan_benda',$hubungan_benda)) && in_array('B2',
              old('hubungan_benda',$hubungan_benda))) checked @endif id="hubungan_benda3" type="checkbox" value="B2">
            <label class="custom-control-label" for="hubungan_benda3">- <strong>B2</strong> = Menjalankan -
              mengontrol mesin</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_benda[]"
              @if(is_array(old('hubungan_benda',$hubungan_benda)) && in_array('B3',
              old('hubungan_benda',$hubungan_benda))) checked @endif id="hubungan_benda4" type="checkbox" value="B3">
            <label class="custom-control-label" for="hubungan_benda4">- <strong>B3</strong> = Mengemudikan /
              menjalankan mesin</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_benda[]"
              @if(is_array(old('hubungan_benda',$hubungan_benda)) && in_array('B4',
              old('hubungan_benda',$hubungan_benda))) checked @endif id="hubungan_benda5" type="checkbox" value="B4">
            <label class="custom-control-label" for="hubungan_benda5">- <strong>B4</strong> = Mengerjakan benda
              dengan tangan atau perkakas</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_benda[]"
              @if(is_array(old('hubungan_benda',$hubungan_benda)) && in_array('B5',
              old('hubungan_benda',$hubungan_benda))) checked @endif id="hubungan_benda6" type="checkbox" value="B5">
            <label class="custom-control-label" for="hubungan_benda6">- <strong>B5</strong> = Melayani
              mesin</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_benda[]"
              @if(is_array(old('hubungan_benda',$hubungan_benda)) && in_array('B6',
              old('hubungan_benda',$hubungan_benda))) checked @endif id="hubungan_benda7" type="checkbox" value="B6">
            <label class="custom-control-label" for="hubungan_benda7">- <strong>B6</strong> = Memasukkan,
              mengeluarkan barang ke/dari mesin</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="hubungan_benda[]"
              @if(is_array(old('hubungan_benda',$hubungan_benda)) && in_array('B7',
              old('hubungan_benda',$hubungan_benda))) checked @endif id="hubungan_benda8" type="checkbox" value="B7">
          ...
          <div class="form-group{{ $errors->has('prestasi_harapan') ? ' has-danger' : '' }}">
            ...
            <textarea name="prestasi_harapan" id="prestasi_harapan" cols="30" rows="5"
              ...
              placeholder="{{ __('Prestasi Kerja Yang Diharapkan') }}"
              value="{{ old('prestasi_harapan',$jabatan->prestasi_harapan) }}"
              required>{{ old('prestasi_harapan',$jabatan->prestasi_harapan) }}</textarea>
    ...
    <div class="card-body">
      ...
      <div class="pl-lg-4">
        ...
        <div class="form-group{{ $errors->has('minat') ? ' has-danger' : '' }}">
          <label class="form-control-label" for="minat">{{ __('Minat Kerja') }}</label>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="minat[]" @if(is_array(old('minat')) && in_array('Investigatif',
              old('minat'))) checked @endif id="minat1" type="checkbox" value="Investigatif">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="minat[]" @if(is_array(old('minat')) && in_array('Enterpreneurial',
              old('minat'))) checked @endif id="minat4" type="checkbox" value="Enterpreneurial">
            <label class="custom-control-label" for="minat4">- <strong>Enterpreneurial</strong> = Pengambilan
              resiko, pengambilan
              keputusan dan negosiasi</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="minat[]" @if(is_array(old('minat')) && in_array('Konvensional',
              old('minat'))) checked @endif id="minat5" type="checkbox" value="Konvensional">
            <label class="custom-control-label" for="minat5">- <strong>Konvensional</strong> = Ketaatan terhadap
              prosedur /
              aturan</label>
          </div>
        ...
        <div class="form-group{{ $errors->has('upaya_fisik') ? ' has-danger' : '' }}">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik')) &&
              in_array('Berdiri', old('upaya_fisik'))) checked @endif id="upaya_fisik1" type="checkbox" value="Berdiri">
            <label class="custom-control-label" for="upaya_fisik1">- <strong>Berdiri</strong> : Berada di suatu
              tempat dalam posisi tegak ditempat tanpa pindah ke tempat lain</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik')) &&
              in_array('membawa', old('upaya_fisik'))) checked @endif id="upaya_fisik5" type="checkbox" value="membawa">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik')) &&
              in_array('menarik', old('upaya_fisik'))) checked @endif id="upaya_fisik7" type="checkbox" value="menarik">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik')) &&
              in_array('menyimpan imbangan / mengatur imbangan', old('upaya_fisik'))) checked @endif id="upaya_fisik9"
              type="checkbox" value="menyimpan imbangan / mengatur imbangan">
            <label class="custom-control-label" for="upaya_fisik9">- <strong>Menyimpan imbangan / mengatur
                imbangan</strong> : Agar
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik')) &&
              in_array('meraba', old('upaya_fisik'))) checked @endif id="upaya_fisik17" type="checkbox" value='meraba'>
            <label class="custom-control-label" for="upaya_fisik17">- <strong>Meraba</strong> : Menyentuh dengan
              jari atau telapak tangan untuk mengetahui sifat-sifat benda seperti suhu, bentuk</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik')) &&
              in_array('ketajaman jarak jauh', old('upaya_fisik'))) checked @endif id="upaya_fisik21" type="checkbox"
              value='ketajaman jarak jauh'>
            <label class="custom-control-label" for="upaya_fisik21">- <strong>Ketajaman Jarak Jauh</strong> :
              Kejelasan penglihatan dalam jarak lebih dari 5 meter</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik')) &&
              in_array('ketajaman jarak dekat', old('upaya_fisik'))) checked @endif id="upaya_fisik22" type="checkbox"
              value='ketajaman jarak dekat'>
            <label class="custom-control-label" for="upaya_fisik22">- <strong>Ketajaman Jarak Dekat</strong>
              :Kejelasan penglihatan dalam jarak kurang dari 5 meter</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik')) &&
              in_array('penyesuaian lensa mata', old('upaya_fisik'))) checked @endif id="upaya_fisik24" type="checkbox"
              value='penyesuaian lensa mata'>
            <label class="custom-control-label" for="upaya_fisik24">- <strong>Penyesuaian Lensa Mata</strong> :
          ...
          <div class="custom-control custom-checkbox mb-3">
            <input class="custom-control-input" name="upaya_fisik[]" @if(is_array(old('upaya_fisik')) &&
              in_array('melihat berbagai warna', old('upaya_fisik'))) checked @endif id="upaya_fisik25" type="checkbox"
              value='melihat berbagai warna'>
            <label class="custom-control-label" for="upaya_fisik25">- <strong>Melihat Berbagai Warna</strong> :
              Membedakan warna yang terdapat dalam pekerjaan</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
        ...
        <div class="form-group{{ $errors->has('umur') ? ' has-danger' : '' }}">
          ...
          <div class="input-group mb-4">
            <input type="text" name="umur" id="umur"
              class="form-control form-control-{{ $errors->has('umur') ? ' is-invalid' : '' }}"
              placeholder="{{ __('Input Umur') }}" value="{{ old('umur') }}" required>
          </div>
          @if ($errors->has('umur'))
          <span class="invalid-feedback" role="alert">
            <strong>{{ $errors->first('umur') }}</strong>
        ...
        <div class="form-group{{ $errors->has('tinggi') ? ' has-danger' : '' }}">
          ...
          <div class="input-group mb-4">
            <input type="text" name="tinggi" id="tinggi"
              class="form-control form-control-{{ $errors->has('tinggi') ? ' is-invalid' : '' }}"
              placeholder="{{ __('Input Tinggi Badan') }}" value="{{ old('tinggi') }}" required>
          </div>
          @if ($errors->has('tinggi'))
          <span class="invalid-feedback" role="alert">
            <strong>{{ $errors->first('tinggi') }}</strong>
        ...
        <div class="form-group{{ $errors->has('berat') ? ' has-danger' : '' }}">
          ...
          <div class="input-group mb-4">
            <input type="text" name="berat" id="berat"
              class="form-control form-control-{{ $errors->has('berat') ? ' is-invalid' : '' }}"
              placeholder="{{ __('Input Berat Badan') }}" value="{{ old('berat') }}" required>
          </div>
          @if ($errors->has('berat'))
          <span class="invalid-feedback" role="alert">
            <strong>{{ $errors->first('berat') }}</strong>
        ...
        <div class="form-group{{ $errors->has('postur') ? ' has-danger' : '' }}">
          ...
          <div class="input-group mb-4">
            <input type="text" name="postur" id="postur"
              class="form-control form-control-{{ $errors->has('postur') ? ' is-invalid' : '' }}"
              placeholder="{{ __('Input Tinggi Badan') }}" value="{{ old('postur') }}" required>
          </div>
          @if ($errors->has('postur'))
          <span class="invalid-feedback" role="alert">
            <strong>{{ $errors->first('postur') }}</strong>
        ...
        <div class="form-group{{ $errors->has('penampilan') ? ' has-danger' : '' }}">
          ...
          <div class="input-group mb-4">
            <input type="text" name="penampilan" id="penampilan"
              class="form-control form-control-{{ $errors->has('penampilan') ? ' is-invalid' : '' }}"
              placeholder="{{ __('Input Tinggi') }}" value="{{ old('penampilan') }}" required>
          </div>
          @if ($errors->has('penampilan'))
          <span class="invalid-feedback" role="alert">
            <strong>{{ $errors->first('penampilan') }}</strong>
