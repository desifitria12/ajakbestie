@extends('layouts.app', ['title' => __('Biodata Jabatan')])

@section('content')
@include('admin.header', ['halaman' => __('Biodata Jabatan')])
      ...
      <div class="card shadow">
        ...
        <div class="card-header border-0">
          <div class="row align-items-center">
            ...
            <div class="col-8">
              <h3 class="mb-0">Biodata Jabatan</h3>
            </div>
                ...
                <tr>
                  ...
                  <th>
                    <div class="text-right">
                      <a href="/biodata_jabatan/{{ $index->kode_jabatan }}/edit" class="btn btn-info btn-sm"
              ...
              <div class="modal-dialog modal-dialog-centered modal-" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h3 class="modal-title">Hapus Data Biodata Jabatan ?</h3>
                  ...
                  <form action="" name="deleteForm" id="deleteForm" method="POST">
                    ...
                    <div class="modal-body">
                      <p>Yakin ingin menghapus <strong id="valuedinas"></strong> ?<br>Semua data Biodata Jabatan akan
