@extends('layouts.app', ['title' => __('Kelola Faktor Struktural')])

@section('content')
@include('admin.header', ['halaman' => __('Kelola Faktor Struktural')])
      ...
      <div class="card shadow">
        ...
        <div class="card-header border-0">
          <div class="row align-items-center">
            <div class="col-8">
              <h3 class="mb-0">Daftar Faktor Struktural</h3>
            </div>
            <div class="col-4 text-right">
              <a href="\create-faktor-struktural" class="btn btn-sm btn-primary p-2 btnTambah">Tambah Faktor</a>
            </div>
