@extends('layouts.app', ['title' => __('Analisis Kompetensi Teknis Jabatan')])

@section('content')
@include('admin.header', ['halaman' => __('Analisis Kompetensi Teknis Jabatan')])
<div class="container-fluid mt--7">
      ...
      <div class="card shadow">
        ...
        <div class="card-header border-0">
          <div class="row align-items-center">
            <div class="col-8">
              <h3 class="mb-0">Analisis Kompetensi Teknis Jabatan</h3>
            </div>
                ...
                <tr>
                  ...
                  <th>
                    <div class="text-right">
                      <a href="/analisis_kompetensi_teknis/{{ $index->kode_jabatan }}/edit" class="btn btn-info btn-sm"
              ...
              <div class="modal-dialog modal-dialog-centered modal-" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h3 class="modal-title">Hapus Data Kompetensi Teknis ?</h3>
                  ...
                  <form action="" name="deleteForm" id="deleteForm" method="POST">
                    ...
                    <div class="modal-body">
                      <p>Yakin ingin menghapus <strong id="valuedinas"></strong> ?<br>Semua data kompetensi teknis akan
  ...
  <script>
    ...
    $(document).on('click', '.btnDelete', function() {
            ...
            var APP_URL = {!! json_encode(url('/analisis_kompetensi_teknis')) !!}
