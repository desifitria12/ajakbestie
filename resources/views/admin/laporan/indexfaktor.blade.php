@extends('layouts.app', ['title' => __('Download Informasi Faktor Jabatan')])

@section('content')
@include('admin.header', ['halaman' => __('Download Informasi Faktor Jabatan')])
      ...
      <div class="card shadow">
        ...
        <div class="card-header border-0">
          <div class="row align-items-center">
            <div class="col-8">
              <h3 class="mb-0">Download Informasi Faktor Jabatan</h3>
            </div>
              ...
              <tbody id="hidden_row{{ $index->id }}" class="hidden_row table table-hover" style="display: none;">
                ...
                <tr>
                  <th class="text-left col-1">
                    <a href="/laporan-faktor/{{$index->kode_jabatan}}" class="btn btn-default btn-sm"
