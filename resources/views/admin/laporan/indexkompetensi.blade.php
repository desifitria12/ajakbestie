@extends('layouts.app', ['title' => __('Download Standar Kompetensi Jabatan')])

@section('content')
@include('admin.header', ['halaman' => __('Download Standar Kompetensi Jabatan')])
      ...
      <div class="card shadow">
        ...
        <div class="card-header border-0">
          <div class="row align-items-center">
            <div class="col-8">
              <h3 class="mb-0">Download Standar Kompetensi Jabatan</h3>
            </div>
              ...
              <tbody id="hidden_row{{ $index->id }}" class="hidden_row table table-hover" style="display: none;">
                ...
                <tr>
                  <th class="text-left col-1">
                    <a href="/laporan-kompetensi/{{$index->kode_jabatan}}" class="btn btn-default btn-sm"
                      data-id_opd="{{$id_opd}}" data-kode_jabatan="{{ $index->kode_jabatan }}"
                      data-jabatan_id="{{ $index->jabatan_id }}"
